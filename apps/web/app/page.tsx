...
import { calculateBaselineBandStats, type BaselineBandStats } from '../src/lib/baseline';
...
function BaselineBandSummary({ stats, strategyName }: { stats: BaselineBandStats; strategyName: string }) {
  return (
